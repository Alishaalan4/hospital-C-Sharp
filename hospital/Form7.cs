    ...
    public partial class Form7 : Form
    {
        ...
        private void fillgridview()
        {
            ...
            using (SqlConnection conn = new SqlConnection(connection))
            {
                ...
                string query = "SELECT * FROM Doctors WHERE DoctorID LIKE @Search OR Name LIKE @Search OR Email LIKE @Search";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            string updateQuery = "UPDATE Doctors SET " +
                        ...
                        "Height = @Height, " +
                        "Weight = @Weight " +
                        "WHERE DoctorID = @Search OR Name = @Search OR Email = @Search";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(textBox5.Text))
            {
                MessageBox.Show("Please enter a Name, ID, or Email to delete.");
                return;
            }

            string deleteQuery = "DELETE FROM Doctors WHERE DoctorID = @Search OR Name = @Search OR Email = @Search";
