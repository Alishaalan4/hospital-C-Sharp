...
namespace hospital
{
    public partial class Form9 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string speiciality = txtSpeiciality.Text;
            ...
            try
            {
                ...
                {
                    // Insert new user
                    string insertQuery = @"INSERT INTO Doctors (Name, Email, Password, BirthDate, BloodType, Gender, Height, Weight,Specialty) 
                                   VALUES (@Name, @Email, @Password, @BirthDate, @BloodType, @Gender, @Height, @Weight,@speiciality)";
                    ...
                    cmd.Parameters.AddWithValue("@speiciality", speiciality);
